...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_method', type = str, default = 'ours', help = "Options: ['ours']")
    parser.add_argument('--dataset', type = str, default = "freqshape")
    ...
    parser.add_argument('--data_path', default="/TimeX/datasets/", type = str, help = 'path to datasets root')
